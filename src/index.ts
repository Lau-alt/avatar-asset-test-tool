...
export async function runMain(collectionFolders: string[]) {
  ...
  for (let collectionFolder of collectionFolders) {
    ...
    const buildAssetsConfig = {
      ...
      contentBaseUrl: `https://avatar-asset-test-tool-pm.vercel.app/`,
